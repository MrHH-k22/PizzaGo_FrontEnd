...
function AddItemModal({
    ...
    }, [isEditMode, initialData, categories]); // Added categories as a dependency
                                ...
                                <div>
                                    ...
                                    <div className="relative rounded-md shadow-sm">
                                        ...
                                        <input
                                            ...
                                            min="0"
                                            step="0.01"
                                            className="w-full pl-14 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:text-white"
                                            placeholder="0.00"
                                        />
                                    </div>
                                </div>
